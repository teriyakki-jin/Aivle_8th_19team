...
@NoArgsConstructor
@AllArgsConstructor
public class ProductionVehicleListResponse {
    ...
    // Entity -> Dto
    public static ProductionVehicleListResponse from(ProductionVehicle productionVehicle) {
        return ProductionVehicleListResponse.builder()
